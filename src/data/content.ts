...
export const projectsData: Project[] = [
  ...
  },
  {
    ...
    summary: 'Modern banking frontend application built as a demonstration of enterprise-grade fintech UI, with clean architecture and optimized backend integration patterns.',
...
export const aboutData = {
  ...
  expertise: [
    { label: 'Full-Stack Development', desc: 'React, TypeScript, .NET, and Python for end-to-end web applications.' },
